% This should change to just add audio to raw matrices after annotations
%% convert all annotated movie files to aligned 3d matrics, and save video+audio+annotated syllables and phrases
...
WorkFolder = '/Users/yardenc/Documents/Experiments/Imaging/CanaryData/lrb853_15/movs/RawData';
...
for fnum = 1:numel(keys)
    ...
    load(fullfile(WorkFolder,OutputFileName),'vidMat','vidTimes','Aud');
    ...
    OutputFileName = ['RawData_' keys{fnum}(1:end-3) 'mat'];
    save(fullfile(WorkFolder,OutputFileName),'vidMat','vidTimes','Aud','-v7.3');
end
