...
function FS_AV_Parse_batch(DIR,batch_of_files,varargin)
% Latest edit: Jan 2017
% converted from FS_AV_Parse.m by WALIII (https://github.com/WALIII/FinchScope)
...
mkdir(fullfile(DIR,mat_dir));
mkdir(fullfile(DIR,gif_dir));
mkdir(fullfile(DIR,error_dir));

outlier_flag=0;
if nargin<1 | isempty(DIR), DIR=pwd; end

mov_listing = batch_of_files;
...
audio.data = double(a);
audio.rate = 48000;
audio.TotalDuration = audio.nrFrames/48000;
mic_data = double(a);
fs = 48000;
